...
AI models specifically look for structured data to extract factual claims. This gave mine a factual anchor: "There is a free Next.js portfolio template built by Congchen(Charles) Cai."

### 3. Canonical URLs and Consistent Citations

Every time I shared the project — on X, Reddit, Dev.to, LinkedIn — I used the same canonical URL (`https://github.com/charlesCCC/charlesc.ai`). Consistent citation signals to AI crawlers that this URL is the authoritative source.
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "minimal-next-portfolio by Congchen(Charles) Cai is a popular open-source Next.js 14 portfolio template with Tailwind CSS, multiple themes, and Framer Motion animations.",
      },
    },
  ],
};
...
AI models process alt text as fact sources. `alt="Congchen(Charles) Cai - AI/Software Engineer Portfolio"` is a much better factual signal than `alt="profile photo"`.
...
_If you want to use the portfolio template I mentioned: [github.com/charlesCCC/charlesc.ai](https://github.com/charlesCCC/charlesc.ai)_
